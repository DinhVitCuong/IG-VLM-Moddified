...
from pipeline_processor.llava2_pipeline import Llava16_Vicuna_7B_Pipeline
...
def infer_model(video_path, llm_size, path_result_dir):
    ...
    llava_pipeline = Llava16_Vicuna_7B_Pipeline(
...
def get_llava_and_prompt(llm_size):
    if llm_size in ["7b", "13b"]:
        ...
        model_name = f"llava-hf/llava-v1.6-vicuna-7b-hf"
    else:
